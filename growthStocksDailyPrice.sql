...
SELECT tickerSymbol FROM [QIAR_TEST].[dbo].[growth_stocks]
...
SELECT 
	...
	into [QIAR_TEST].[dbo].[daily_growth_stock_returns]
FROM 
...
--select top 62 * from ciqPriceEquity where tradingItemID= 1816998317 order by pricingDate desc

--select * from [QIAR_TEST].[dbo].[daily_growth_stock_returns] order by pricingDate desc

-- drop table [QIAR_TEST].[dbo].[daily_growth_stock_returns]

--select * from [QIAR_TEST].[dbo].[daily_growth_stock_returns]
