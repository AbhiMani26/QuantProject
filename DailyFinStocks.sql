...
SELECT tickerSymbol FROM [QIAR_TEST].[dbo].[fin_stocks]
...
SELECT 
	...
	into [QIAR_TEST].[dbo].[daily_fin_stock_returns]
FROM 
...
--select * from [QIAR_TEST].[dbo].[daily_fin_stock_returns] order by pricingDate desc

-- drop table [QIAR_TEST].[dbo].[daily_fin_stock_returns]

--select * from [QIAR_TEST].[dbo].[daily_fin_stock_returns]
